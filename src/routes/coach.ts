...
router.get("/athletes/:athleteId/sport-reviews", gymOwnerAuth, CoachController.getAthleteSportReviews);
router.get("/athletes/:athleteId/skill-training", gymOwnerAuth, CoachController.getAthleteSkillTraining);
router.get("/athletes/:athleteId/physical-performance", gymOwnerAuth, CoachController.getAthletePhysicalPerformance);
